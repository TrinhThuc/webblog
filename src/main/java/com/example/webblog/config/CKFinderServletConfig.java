...
//        registrationBean.addInitParameter("XMLConfig","/webapp/static/writingpage/ckfinder.xml");
//        registrationBean.addInitParameter("debug","false");
//        registrationBean.addInitParameter("configuration","com.example.webblog.config.CKFinderConfig");
//        //ckfinder.xml
